...
import { ArrowRight, BrainCircuit, Building2, ChevronRight, Cpu, Map, Play, Shield, Users, X } from "lucide-react";
  ...
  return <PageShell>
    <main>
      <section className="hero">
        ...
        <div className="hero__actions"><Link to="/dashboard" className="button button--primary">Open command center <ArrowRight size={17}/></Link></div>
